 ...
 * 同じポインタの場合は、何も行わない。
 */
    inline static void copyRGB888Pixels(const uint8_t *src_rgb888, const PixelFormat_e dstFormat, uint8_t *dst, const uint _pixels) {
        if (src_rgb888 == dst) {
            return;
        }
 ...
 */
    ...
    inline static void copyBGRA8888Pixels(const uint8_t *src_bgra8888, const PixelFormat_e dstFormat, uint8_t *dst, const uint _pixels) {
        if (src_bgra8888 == dst) {
            return;
        }
